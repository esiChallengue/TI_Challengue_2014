...
public class Funciones
{
    ...
    public void OpcionesBD(View inflatedV, String Opcion, Context ctx, String dataBaseName){
        ...
        EditText NotasEditText   = (EditText)inflatedV.findViewById(R.id.editTextNotas);
        ...
        String NotasValue = NotasEditText.getText().toString();
        ...
        if(Opcion.equals("guardarOpcionesBD")){
            ...
            if (cur.moveToFirst() == false) {
               ...
               // if (cur.getInt(0) == 0) {
                    ...
                    valuesOpciones.put("notas", NotasValue);
              ...
              //  }
                ...
                db.execSQL("UPDATE opciones SET nameServer1='"+nameServer1+"', ipServer1='"+ipServer1+"'"
                        ...
                        + ", Server1Passphrase='"+Server1Passphrase+"', Server1TrackingNumber='"+Server1TrackingNumber+"'"
                        + ", BtMacAddressValue='"+BtMacAddressValue+"', BtNameValue='"+BtNameValue+"'"
                        + ", nombreOperario='"+NombreOperarioValue+"', apellidosOperario='"+ApellidosOperarioValue+"'"
                        + ", dniOperario='"+DniOperarioValue+"', numeroTelefono='"+NumeroTelefonoOperarioValue+"'"
                        + ", notas='"+NotasValue+"'"
                        + " WHERE id_opcion='1'");
            }
          GuardarFrameLayout.setVisibility(View.VISIBLE); // Hacemos visible el layout de guardado
            ...
            if (fila.moveToFirst()) {
                ...
                do {
                    ...
                    NotasEditText.setText(fila.getString(12));
    ...
    public void actualizarLayer(View inflatedV, String Opcion, Context ctx, String temperatura, String xAxis, String yAxis, String zAxis){
        ...
        TextView textViewAcelerometroXaxisValue   = (TextView)inflatedV.findViewById(R.id.textViewAcelerometroXaxisValue);
        TextView textViewAcelerometroYaxisValue   = (TextView)inflatedV.findViewById(R.id.textViewAcelerometroYaxisValue);
        TextView textViewAcelerometroZaxisValue   = (TextView)inflatedV.findViewById(R.id.textViewAcelerometroZaxisValue);
        ...
        //Recureamos el nombre del enlace, que será el del trackingNumber
        dbHelper = new DBHelper(ctx, dataBaseName);
        db = dbHelper.getWritableDatabase();
        fila = db.rawQuery("SELECT * FROM datos ORDER BY id_dato DESC LIMIT 1",null);
        //Nos aseguramos de que existe al menos un registro
        if (fila.moveToFirst()) {
            //Recorremos el cursor hasta que no haya m�s registros
            do {
                // displaying all data in textview
                temperatura= fila.getString(1);
                xAxis= fila.getString(2);
                yAxis= fila.getString(3);
                zAxis= fila.getString(4);
            } while(fila.moveToNext()); }
        fila.close();
        db.close();
        dbHelper.close();
        ...
        textViewChipTemperaturaValue.setText(temperatura +" ºC");
        textViewAcelerometroXaxisValue.setText(xAxis + " G");
        textViewAcelerometroYaxisValue.setText(yAxis + " G");
        textViewAcelerometroZaxisValue.setText(zAxis + " G");
