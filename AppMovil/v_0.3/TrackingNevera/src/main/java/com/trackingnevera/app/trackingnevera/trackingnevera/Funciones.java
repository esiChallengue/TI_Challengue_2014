...
public class Funciones
{
    ...
    public void actualizarLayer(View inflatedV, String Opcion, Context ctx){
        ...
        textViewServer1StatusGPS.setText("prueba1");
        textViewServerLatitudNumber.setText("prueba2");
        textViewServerLongitudNumber.setText("prueba3");
        textViewServerBTEstado.setText("prueba4");
        textViewServerNombreEnlaceValue .setText("prueba5");
